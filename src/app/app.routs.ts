...
export const APP_ROUTES: Routes = [
    ...
    {'path':'termsandconditions', component:TermsandconditionsComponent, resolve: { spinner: SpinnerResolverService } },
    {'path':'counsellors', component:CounsellorsComponent, resolve: { spinner: SpinnerResolverService } },
    //user/student pages
